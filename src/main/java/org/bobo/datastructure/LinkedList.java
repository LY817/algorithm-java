...
public class LinkedList<E> implements List<E> {
    ...
    public E get(int index) {
        return getPevNode(index).getNext().getE();
    }
     ...
     * @return
     */
    public Node getPevNode(int index) {
        if (index + 1 > size) {
            throw new IndexOutOfBoundsException();
        }
        Node pevPtr = dummyHead;
        for (int i = 0; i < index; i++) {
            pevPtr = pevPtr.getNext();
        }
        return pevPtr;
    }
    ...
    public void add(int index, E element) {
        ...
        Node pevNode = getPevNode(index);
        Node current = pevNode.getNext();
        Node addOne = new Node(element, current);
        pevNode.setNext(addOne);
        size++;
    }
    ...
    public String toString() {
        ...
        Node pevPtr = dummyHead;
        while (pevPtr.next != null) {
            stringBuilder.append(pevPtr.next.e);
            pevPtr = pevPtr.next;
            if(pevPtr.next != null) {
